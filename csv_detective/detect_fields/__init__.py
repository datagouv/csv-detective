...
from .FR.geo import adresse, code_commune_insee, code_postal, commune, departement, pays, region, code_departement, code_fantoir, latitude_wgs_fr_metropole, longitude_wgs_fr_metropole, code_region
