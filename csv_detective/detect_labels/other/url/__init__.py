...
def _is(header):
    ...
    words_combinations_list = ['url', 'url source', 'site web', 'source url', 'site internet', 'remote url', 'web', 'site', 'lien', 'site data', 'lien url', 'lien vers le fichier', 'sitweb', 'interneturl']
