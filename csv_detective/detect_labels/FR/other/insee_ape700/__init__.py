...
def _is(header):
    ...
    words_combinations_list = ['code ape', 'code activite (ape)', 'code naf', 'code naf organisme designe', 'code naf organisme designant', "base sirene : code ape de l'etablissement siege"]
