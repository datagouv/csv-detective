...
def _is(header):
    ...
    words_combinations_list = ['latlon wgs', 'latlon', 'geo point', 'geo point 2d', 'wgs84', 'geolocalisation', 'geo', 'coordonnees finales', 'coordonnees',
        'coordonnees ban', 'xy', 'geometry x y', 'coordonnees insee', 'coordonnees geographiques', 'position', 'coordonnes gps', 'geopoint', 'geom x y',
        'coord gps', 'latlong', 'position geographique', 'c geo', 'coordonnes geoloc', 'lat lon', 'code geo', 'geo localisation', 'coordonnes geo', 'geo cp',
        'x y', 'geo coordinates', 'point geo', 'point geo insee', 'coordonnees geoloc', 'coordonnees xy']
